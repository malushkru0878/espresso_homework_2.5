...
public class ElementSettingsTest {

    @Rule
    public ActivityScenarioRule<MainActivity> mActivityScenarioRule = new ActivityScenarioRule<>(MainActivity.class);

    @Test
    public void elementSettingsTest() {
        Intents.init();
        ...
        ViewInteraction textView = onView(allOf(withId(androidx.recyclerview.R.id.title), withText("Settings"),
        ...
        ViewInteraction materialTextView = onView(allOf(withId(androidx.recyclerview.R.id.title), withText("Settings"),
                        childAtPosition(childAtPosition(withId(androidx.constraintlayout.widget.R.id.content),0),0),
                        isDisplayed()));
